...
# TODO combine with other run.py script

root_dir = os.getenv("IRIS_HOME")
if not root_dir:
    raise RuntimeError("Set $IRIS_HOME")
gen_script = f"{root_dir}/examples/malicious_sites/generate.py"
prog = "malicious_sites"
...
if __name__ == "__main__":
    ...
    for exp in range(start_exp, end_exp + 1):
        ...
        os.system(f"rm -f ./target/release/deps/{prog}*") # force rebuild
